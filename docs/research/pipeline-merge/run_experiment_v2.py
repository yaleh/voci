"""Merged pipeline experiment v2: Config C few-shot prompt + single Gemini call.

Usage:
  python3 docs/research/pipeline-merge/run_experiment_v2.py

Appends rows to results_v2.jsonl. Reads API key from ~/.config/voci/config.yaml.
"""
